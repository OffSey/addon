...
RegisterServerCallback('fg:addon:get:antiVehicle',function (source,cb)
    local data = LoadResourceFile(CurrentResourceName,'client/cl_antivehicle.lua')
    cb(data)
end)

RegisterServerCallback('fg:addon:get:nativePermissionsExports',function (source,cb)
    local data = LoadResourceFile(CurrentResourceName,'client/cl_native_permissions.lua')
    cb(data)
end)
